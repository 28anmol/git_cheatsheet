...
*Disclaimer: Redundant commands have been intentionally repeated in relevant sections for user convenience, emphasis and ease of use. Formatting readme work still in progress! Have Patience!* 😉
...
# You can move your HEAD to any commit(detached HEAD) which helps in inspection, navigation and inspection of git commit history
...
git mv oldfilename.cpp newfilename.cpp	# Renaming/Relocating files in git - then add commit and push
